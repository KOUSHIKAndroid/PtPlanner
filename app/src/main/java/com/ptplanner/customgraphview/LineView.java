package com.ptplanner.customgraphview;
...
public class LineView extends View {
    ...
    private final int BOTTOM_TEXT_COLOR = Color.parseColor("#000000");
    ...
    //라인컬러
    private String[] colorArray = {"#22A7F0", "#22A7F0", "#22A7F0"};
    //popup 컬러
    private int[] popupColorArray = {R.drawable.popup_blue, R.drawable.popup_blue, R.drawable.popup_blue};
    ...
    private void drawDots(Canvas canvas) {
        ...
        smallCirPaint.setColor(Color.parseColor("#22A7F0")); //rf
