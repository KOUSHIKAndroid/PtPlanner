...
public class ShowCalendarPopUpBookApp extends PopupWindow implements OnClickListener {
    ...
    public ShowCalendarPopUpBookApp(final Context context, final String TYPE) {
        super(context);
...
//            Toast.makeText(context,context.getResources().getString(R.string.no_internet),Toast.LENGTH_LONG).show();
        ...
        btnPre.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                AppConfig.currentMonthBookApp--;

                if (AppConfig.currentMonthBookApp == 0) {
                    AppConfig.currentMonthBookApp = 12;
                    AppConfig.currentYearBookApp--;
                }
        ...
        btnNext.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (AppConfig.currentMonthBookApp > 11) {
                    AppConfig.currentMonthBookApp = 1;
                    AppConfig.currentYearBookApp++;
                } else {
                    AppConfig.currentMonthBookApp++;
                }

                next.set(Calendar.MONTH, AppConfig.currentMonthBookApp);
                next.set(Calendar.YEAR, AppConfig.currentYearBookApp);
    ...
    public void getCalendar(int currentMonth, int indexOfDayOne, int curyear) {
        ...
        Calendar current = (Calendar) AppConfig.calendarBookApp.clone();

        current.set(Calendar.MONTH, currentMonth - 1);
        current.set(Calendar.YEAR, curyear);
        current.set(Calendar.DATE, AppConfig.currentDateBookApp);
...
//                        if (dateSavePreference.getString("ClickDatePreferenceType", "").equals(TYPE)) {
...
//                        }
    ...
    public void getLayouts() {
        ...
        for (int i = 0; i < eventViewRoundArr.length; i++) {
            ...
            eventViewRoundArr[i].setBackgroundResource(R.drawable.circle_event_book_app);
        }
        ...
        AsyncTask<Void, Void, Void> event = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    // Log.d("Available Date",""+jarrayAvailableDate.toString());

                    calEventData = new CalendarEventDataType();
                    for (int i = 0; i < jArrProgram.length(); i++) { //biku
