...
import com.happywannyan.Utils.helper.ContinuousTask;
import com.happywannyan.Utils.helper.LocationUtils;
import com.happywannyan.Utils.helper.LogUtils;
import com.happywannyan.Utils.helper.PermissionManager;
import com.happywannyan.Utils.provider.DefaultLocationProvider;
import com.happywannyan.Utils.provider.GPServicesLocationProvider;
import com.happywannyan.Utils.provider.LocationProvider;
 ...
 */
public class MyLocalLocationManager {
     ...
     */
    public MyLocalLocationManager(LocationConfiguration configuration) {
     ...
     */
    public MyLocalLocationManager on(Activity activity) {
     ...
     */
    public MyLocalLocationManager notify(LocationReceiver listener) {
     ...
     */
    public MyLocalLocationManager setConfiguration(LocationConfiguration configuration) {
        this.configuration = configuration;
        return this;
    }
    ...
    /**
     * To determine whether MyLocalLocationManager is currently waiting for location or it did already receive one!
     */
